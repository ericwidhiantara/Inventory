...
export default class UpdateInventory extends Component<Props> {
                 ...
                 constructor(props) {
                   ...
                   this.state = {
                     ...
                     isError: false,
                     refreshing: false,
                     MATERIAL_ID: this.props.navigation.state
                       .params.MATERIAL_ID,
                     SKU: this.props.navigation.state.params.SKU,
                     BARCODE: this.props.navigation.state.params
                       .BARCODE,
                     NAME: this.props.navigation.state.params
                       .NAME,
                     CATEGORY_ID: this.props.navigation.state
                       .params.CATEGORY_ID,
                     DEFAULT_PRICE: this.props.navigation.state
                       .params.DEFAULT_PRICE,
                     LAST_UPDATE: LAST_UPDATE,
                     hidePassword: true,
                     ModalVisibleStatus: false,
                     serverAddress: this.props.navigation.state
                       .params.serverAddress,
                     serverPort: this.props.navigation.state
                       .params.serverPort,
                     serverFullAddress: this.props.navigation
                       .state.params.serverFullAddress
                   };
                 }
                 componentDidMount() {
                       ...
                       fetch(
                           ...
                           this.state.MATERIAL_ID,
                         {
                           ...
                           body: JSON.stringify({
                             ...
                             SUB_CATEGORY_ID: this.state
                               .SUB_CATEGORY_ID,
                             DEFAULT_PRICE: this.state
                               .DEFAULT_PRICE,
