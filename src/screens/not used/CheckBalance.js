      ...
      <View style={{ flex: 1 }}>
        <DrawerLayout
          ...
          <View style={{ paddingHorizontal: 20, flex: 1 }}>
            <Text style={{ textAlign: "center", fontSize: 18, marginTop: 30 }}>{this.state.name}</Text>
            <Text style={{ textAlign: "center", fontSize: 18, marginTop: 20 }}>Total Balance</Text>
            ...
            <Text style={{ textAlign: "center", fontSize: 18, marginTop: 20 }}>Tag Deposit</Text>
            ...
            <TouchableOpacity
              style={{ backgroundColor: '#4caf50', margin: 5, padding: 10, marginTop: 50, borderRadius: 3}}
              onPress={() => { this.setState({ isWritingToTagSucess: false }, this.startReadTag) }}>
              <Text style={{ textAlign: "center", color: '#FFFFFF', fontSize: 18 }}>READ TAG AGAIN</Text>
            </TouchableOpacity>
